...
export const Footer = () => {
  return (
    <>
      ...
      <footer className={'flex flex-col mx-auto w-full space-y-2'}>
      ...
      <footer
        className={
          'sm:hidden border-t border-t-border-main sticky bottom-0 py-1.5 px-4 mt-0 w-auto bg-transparent z-50 after:absolute after:inset-0 after:-z-50  after:bg-dark-primary/80 after:dark:bg-dark-bg/80 after:backdrop-saturate-[180%] after:backdrop-blur-[20px] after:shadow-lg after:shadow-dark-primary/50 dark:after:shadow-dark-bg/50 md:after:shadow-xl md:after:shadow-dark-primary/50 shadow-md'
        }>
        <div className={'flex flex-row justify-center max-w-3 items-center py-0 '}>
